...
if __name__ == "__main__":
    ...
    #boundary_points = bc.get_room_perimeter_points_1st_pass(reachable_room_points, unreachable_room_points, room_of_placement, bc.na)
    ...
    filtered_points = filtered_points.union(rects_vert).union(rects_horiz)
    bc.visualize(filtered_points)
    ...
    separated_boundaries = bc.get_room_perimeter_points_2nd_pass(filtered_points, bc.na)
